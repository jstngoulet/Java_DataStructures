...
public class Programming_Project2_PrevHW {
//this is actually prject 3 (with the students)

	public static KWLinkedList <String> students;
	...
	public static void main(String[] args) {
		...
		//Init students
		students = new KWLinkedList<String>(null, null, 0);
